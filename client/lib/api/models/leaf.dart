...
class Leaf {
  ...
  late final List<Content> teamContents;
  late final List<Content> definitionContents;
  late final int createdAt;
  late final int updatedAt;

  Leaf({required this.id, required this.userId, required this.treeNodeId, required this.title, required this.teamContents, required this.definitionContents, required this.createdAt, required this.updatedAt});
  ...
  factory Leaf.fromJson(Map<String, dynamic> json) {
    ...
    final teamContents = (json['teamContents'] as List<dynamic>?)?.map((e) => Content.fromJson(e as Map<String, dynamic>)).toList() ?? [];
    ...
    return Leaf(id: id, userId: userId, treeNodeId: treeNodeId, title: title, teamContents: teamContents, definitionContents: definitionContents, createdAt: createdAt, updatedAt: updatedAt);
  }
}
