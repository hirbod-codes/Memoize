...
# -----------------------------------------------------------------------------
SECRET_ORDER=(
    MEMOIZE_MELIPAYAMAK_USERNAME
    MEMOIZE_MELIPAYAMAK_API_KEY
    MEMOIZE_MELIPAYAMAK_FROM
    MEMOIZE_ZARINPAL_MERCHANT_ID
    MEMOIZE_TTS_API_KEY
    MEMOIZE_BUCKET_NAME
    ...
    MEMOIZE_REDIS_USERNAME
    MEMOIZE_REDIS_PASSWORD
    MEMOIZE_REDIS_MASTER_PASSWORD

    MEMOIZE_GF_SECURITY_ADMIN_USER
...
declare -A MODE=(
    [MEMOIZE_MELIPAYAMAK_USERNAME]="required"
    [MEMOIZE_MELIPAYAMAK_API_KEY]="required"
    [MEMOIZE_MELIPAYAMAK_FROM]="required"
    [MEMOIZE_ZARINPAL_MERCHANT_ID]="required"
    ...
    [MEMOIZE_MONGODB_USERNAME]="required"
    ...
    [MEMOIZE_REDIS_USERNAME]="mirror:MEMOIZE_MONGODB_USERNAME"
    [MEMOIZE_REDIS_PASSWORD]="mirror:MEMOIZE_MONGODB_PASSWORD"
    [MEMOIZE_REDIS_MASTER_PASSWORD]="mirror:MEMOIZE_MONGODB_PASSWORD"

    [MEMOIZE_GF_SECURITY_ADMIN_USER]="mirror:MEMOIZE_MONGODB_USERNAME"
    [MEMOIZE_GF_SECURITY_ADMIN_PASSWORD]="mirror:MEMOIZE_MONGODB_PASSWORD"
...
declare -A TARGET_SERVICE=(
    [MEMOIZE_MELIPAYAMAK_USERNAME]="memoize"
    [MEMOIZE_MELIPAYAMAK_API_KEY]="memoize"
    [MEMOIZE_MELIPAYAMAK_FROM]="memoize"
    [MEMOIZE_ZARINPAL_MERCHANT_ID]="memoize"
    [MEMOIZE_REDIS_USERNAME]="memoize"
    [MEMOIZE_REDIS_PASSWORD]="memoize"
    ...
    [MEMOIZE_GF_SECURITY_ADMIN_USER]="grafana"
    ...
    [MEMOIZE_REDIS_MASTER_PASSWORD]="redis"
)
